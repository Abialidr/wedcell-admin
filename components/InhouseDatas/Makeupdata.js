...
export default function Makeupdata() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const result = await axios.get(`${PROXY}/adminessentials/makeup`, config);
      ...
      <Grid
        ...
        {data?.map((item, key) => {
          return (
            <Grid item xs={3} sm={3} md={3} key={key}>
              <TextField
                value={item.experince}
                onChange={(e) => {
                  const arr = data;
                  arr[key].experince = e.target.value;
                  setdata([...arr]);
                }}
                label="Price"
                multiline
          ...
          return (
            <Grid item xs={3} sm={3} md={3} key={key}>
              <TextField
                ...
                onChange={(e) => {
                  const arr = data;
                  arr[key].products = e.target.value;
                  setdata([...arr]);
                }}
                label="Price"
                multiline
          ...
          return (
            <Grid
              ...
              <input
                ...
                onChange={(e) => {
                  const arr = data;
                  arr[key].Makeup = e.target.checked;
                  setdata([...arr]);
                }}
                name=""
                id=""
        ...
        {data?.map((item, key) => {
          return (
            <Grid
              ...
              key={key}>
              <input
                checked={item.Draping}
                onChange={(e) => {
                  const arr = data;
                  arr[key].Draping = e.target.checked;
                  setdata([...arr]);
                }}
                type="checkbox"
                name=""
          ...
          return (
            <Grid
              ...
              <input
                ...
                onChange={(e) => {
                  const arr = data;
                  arr[key].Lashes = e.target.checked;
                  setdata([...arr]);
                }}
                type="checkbox"
                name=""
